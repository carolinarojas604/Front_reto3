...
function editarRegistro(llaveRegistro) {
    alert("Función de borrado disponible hasta el reto 4...");
}
...
function actualizar() {
    ...
    if (validarEditar()) {
        $.ajax({
            ...
            url: "https://g2c7d8c8e491995-db202109201320.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike",
